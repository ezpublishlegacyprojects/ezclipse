...
import ch.wess.ezclipse.ini.tests.editor.internal.partition.INIPartitionScannerTest;
import ch.wess.ezclipse.ini.tests.editor.internal.partition.INIPartitionerTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    INIPartitionerTest.class,
    INIPartitionScannerTest.class
})
